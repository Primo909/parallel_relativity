...
NonLinearWaveEquationSolver1D::NonLinearWaveEquationSolver1D(){}

void NonLinearWaveEquationSolver1D::Info_Conv_Test(double dx, string file_name){
    cout<<endl;
...
void NonLinearWaveEquationSolver1D::Saving_Data_File(int N, double* state_vector, double* axis, int iteration){
...
void NonLinearWaveEquationSolver1D::SetInitialConditions(int N, double *y, double* InitialState){
    for(int j=0; j<2*N; j++) y[j]=InitialState[j];
}

void NonLinearWaveEquationSolver1D::SecondDerivative(int N, double dx, double* field, double* second_derivative_vector){
    int number_ghosts=3;
...
void NonLinearWaveEquationSolver1D::RuggeKutta(int N, double dx, double dt, double* state_vector){
...
void NonLinearWaveEquationSolver1D::Solve(double xmin, double xmax, double dx, double* InitialState, double dt=1E-3, double simul_time=2, bool file=false){
...
void NonLinearWaveEquationSolver1D::PointConvergenceTest(double (*func1)(double), double (*func2)(double), string filename){
...
void NonLinearWaveEquationSolver1D::NormConvergenceTest(double (*func1)(double), double (*func2)(double), string filename){
